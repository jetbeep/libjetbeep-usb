...
typedef void (*jetbeep_easypay_payment_result_cb)(const jetbeep_easypay_payment_result_t& result);
typedef void (*jetbeep_easypay_refund_result_cb)(const jetbeep_easypay_refund_result_t& result);
