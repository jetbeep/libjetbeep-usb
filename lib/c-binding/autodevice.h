...
typedef void (*jetbeep_autodevice_barcode_result_cb)(jetbeep_error_t error, jetbeep_barcode_t* barcodes, size_t size, void* data);
typedef void (*jetbeep_autodevice_payment_result_cb)(jetbeep_error_t error, void* data);
typedef void (*jetbeep_autodevice_payment_token_result_cb)(jetbeep_error_t error, const char* token, void* data);
typedef void (*jetbeep_autodevice_payment_error_cb)(jetbeep_error_t error, void* data);
typedef void (*jetbeep_autodevice_state_cb)(jetbeep_state_t state, void* data);
typedef void (*jetbeep_autodevice_mobile_connected_cb)(bool connected, void* data);
