...
typedef void (*jetbeep_autodevice_payment_token_result_cb)(const char* token, size_t size);
typedef void (*jetbeep_autodevice_payment_error_cb)(jetbeep_error_t error);
typedef void (*jetbeep_autodevice_state_cb)(jetbeep_state_t state, jetbeep_error_t error);
...
JETBEEP_API void* jetbeep_autodevice_opaque(jetbeep_autodevice_handle_t handle);
JETBEEP_API jetbeep_state_t jetbeep_autodevice_state(jetbeep_autodevice_handle_t handle);
JETBEEP_API void jetbeep_autodevice_set_payment_error_callback(jetbeep_autodevice_handle_t handle, jetbeep_autodevice_payment_error_cb callback);
...
JETBEEP_API void jetbeep_autodevice_set_mobile_connected_callback(jetbeep_autodevice_handle_t handle, jetbeep_autodevice_mobile_connected_cb callback);
