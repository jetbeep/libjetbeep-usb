...
function jetbeep_autodevice_start(handle: TAutoDeviceHandle): TCJetBeepError; cdecl;
function jetbeep_autodevice_stop(handle: TAutoDeviceHandle): TCJetBeepError; cdecl;
function jetbeep_autodevice_open_session(handle: TAutoDeviceHandle): TCJetBeepError; cdecl;
function jetbeep_autodevice_close_session(handle: TAutoDeviceHandle): TCJetBeepError; cdecl;
function jetbeep_autodevice_request_barcodes(handle: TAutoDeviceHandle; callback: TCJetBeepBarcodesCallback; data: THandle): TCJetBeepError; cdecl;
function jetbeep_autodevice_cancel_barcodes(handle: TAutoDeviceHandle): TCJetBeepError; cdecl;
function jetbeep_autodevice_create_payment_token(handle: TAutoDeviceHandle; amountInCoins: Cardinal; tranasctionId: PAnsiChar; callback: TCJetBeepPaymentTokenCallback; data: THandle; cashierId: PAnsiChar; metadata: PJetBeepMetadata; metadataSize: Integer): TCJetBeepError; cdecl;
function jetbeep_autodevice_cancel_payment(handle: TAutoDeviceHandle): TCJetBeepError; cdecl;
...
procedure jetbeep_autodevice_set_state_callback(handle: TAutoDeviceHandle; callback: TCJetBeepDeviceStateCallback; data: THandle); cdecl;
procedure jetbeep_autodevice_set_mobile_connected_callback(handle: TAutoDeviceHandle; callback: TCJetBeepMobileConnectedCallback; data: THandle); cdecl;
