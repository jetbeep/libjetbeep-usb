...
type
  ...
  TCJetBeepError = (JETBEEP_NO_ERROR = 0, JETBEEP_ERROR_INVALID_STATE = 1,
    JETBEEP_ERROR_IO = 2);
  ...
  TJetBeepDeviceState = (JETBEEP_STATE_INVALID = 0,
    ...
    JETBEEP_STATE_SESSION_OPENED, JETBEEP_STATE_SESSION_CLOSED,
  ...
  TEasyPayEnvironment = (EASYPAY_BACKEND_DEVELOPMENT = 0,
  ...
  TCJetBeepMetadata = record
    ...
    TCEasyPayPaymentResult = record errorString: PAnsiChar;
  ...
  TCJetBeepBarcodesCallback = procedure(error: TCJetBeepError;
    barcodes: PJetBeepBarcode; barcodesSize: Integer; data: THandle); cdecl;
  TCJetBeepPaymentTokenCallback = procedure(error: TCJetBeepError;
    token: PAnsiChar; data: THandle); cdecl;
  TCJetBeepDeviceStateCallback = procedure(state: TJetBeepDeviceState;
    data: THandle); cdecl;
  TCJetBeepMobileConnectedCallback = procedure(connected: Boolean;
    data: THandle); cdecl;
  TEasyPayPaymentResultCallback = procedure(result: TCEasyPayPaymentResult;
    data: THandle); cdecl;
